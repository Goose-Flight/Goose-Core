"""Generic CSV flight log parser — NOT YET IMPLEMENTED.
...
class CSVParser(BaseParser):
    """Stub for generic CSV flight log format — not implemented."""
    ...
    def parse(self, filepath: str | Path) -> ParseResult:
        ...
        diag = ParseDiagnostics.unsupported(ext, parser_name="CSVParser")
        diag.errors = [
            "CSV format is not yet implemented. "
